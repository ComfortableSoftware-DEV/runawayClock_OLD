TBGLST = [
	...
	("PSGVAL__AVOID_MOUSE", FMAXPSG_SCTN0901_KEYDEF, "AVOID_MOUSE", "",),
	("PSGVAL__DISMISSED", FMAXPSG_SCTN0901_KEYDEF, "DISMISSED", "alarm dismissed bool",),
	("PSGVAL__EVENT_ENTRIES", FMAXPSG_SCTN0901_KEYDEF, "EVENT_ENTRIES", "",),
	("PSGVAL__EVENT_MODE", FMAXPSG_SCTN0901_KEYDEF, "EVENT_MODE", "",),
	("PSGVAL__INDEX_OF_NEXT_EVENT", FMAXPSG_SCTN0901_KEYDEF, "INDEX_OF_NEXT_EVENT", "",),
	("PSGVAL__MAIN_FONT", FMAXPSG_SCTN0901_STRDEF, "MAIN_FONT", "Source Code Pro", "set the main font",),
	...
	("PSGVAL__TIME_ALARM", FMAXPSG_SCTN0901_KEYDEF, "TIME_ALARM", "",),
	("PSGVAL__TIME_ELAPSED", FMAXPSG_SCTN0901_KEYDEF, "TIME_ELAPSED", "24 hour centric elapsed time running, can be reset, may go to 99h",),
	("PSGVAL__TIME_INTERVAL", FMAXPSG_SCTN0901_KEYDEF, "TIME_INTERVAL", "",),
	("PSGVAL__TIME_OF_NEXT_EVENT", FMAXPSG_SCTN0901_KEYDEF, "TIME_OF_NEXT_EVENT", "what time is the next alarm, == TIME_ALARM is tomorrow",),
	("PSGVAL__TIME_REMIND", FMAXPSG_SCTN0901_KEYDEF, "TIME_REMIND", "",),
	("PSGVAL__TIME_TO_NEXT_EVENT", FMAXPSG_SCTN0901_KEYDEF, "TIME_TO_NEXT_EVENT", "down counter to next event on this window/alarm/interval/reminder",),
	("PSGVAL__TRANSPARENT", FMAXPSG_SCTN0901_KEYDEF, "TRANSPARENT", "",),
	("PSGVAL__TRANSPARENT_UNDER_MOUSE", FMAXPSG_SCTN0901_KEYDEF, "TRANSPARENT_UNDER_MOUSE", "is the clock transparent under mouse (ineffective if mouse is avoided)",),
	...
	("PSGVAL___CIRCLE_COLOR", FMAXPSG_SCTN0901_STRDEF, "CIRCLE_COLOR", "circle_color", "",),
	("PSGVAL___CLICK_SUBMITS", FMAXPSG_SCTN0901_STRDEF, "CLICK_SUBMITS", "click_submits", "",),
	...
	("PSGVAL___FOCUS", FMAXPSG_SCTN0901_STRDEF, "FOCUS", "focus", "",),
	...
	("PSGVAL___GROUP_ID", FMAXPSG_SCTN0901_STRDEF, "GROUP_ID", "group_id", "",),
	...
	("PSGVAL___INITIAL_VALUE", FMAXPSG_SCTN0901_STRDEF, "INITIAL_VALUE", "INITIAL_VALUE", "",),
	...
	("PSGVAL___RELIEF", FMAXPSG_SCTN0901_STRDEF, "RELIEF", "relief", "",),
	...
	("PSGVAL___SET_TO_INDEX", FMAXPSG_SCTN0901_STRDEF, "SET_TO_INDEX", "set_to_index", "change selection to a particular choice starting with index = 0",),
	...
	("PSGVAL___VALUE", FMAXPSG_SCTN0901_STRDEF, "VALUE", "value", "the value of the element",),
	("PSGVAL___VALUES", FMAXPSG_SCTN0901_STRDEF, "VALUES", "values", "list of values",),
