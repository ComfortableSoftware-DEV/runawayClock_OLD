...
K_TIME_S_AT_NEXT_ALERT = "K_TIME_S_AT_NEXT_ALERT"  # time at next event
...
K_TIME_S_AT_ZEROELAPSE = "K_TIME_S_AT_ZEROELAPSE"  # time at last zero of elapsed timer
K_TIME_S_CLOCK = "K_TIME_S_CLOCK"  # time clock or wall clock
K_TIME_S_ELAPSED = "K_TIME_S_ELAPSED"  # time elapsed
...
K_TIME_S_TOGO = "K_TIME_S_TOGO"  # countdown to next event
...
PSG.K_CURRENT_INTERVAL_COUNT = "PSG.K_CURRENT_INTERVAL_COUNT"  # interval count template
PSG.K_NAME_NEXT_EVENT = "PSG.K_NAME_NEXT_EVENT"  # interval count template
PSG.K_TIME_S_AT_NEXT_ALERT = "PSG.K_TIME_S_AT_NEXT_ALERT"  # interval count template
PSG.K_TIME_S_AT_ZEROELAPSE = "PSG.K_TIME_S_AT_ZEROELAPSE"  # interval count template
PSG.K_TIME_S_CLOCK = "PSG.K_TIME_S_CLOCK"  # interval count template
PSG.K_TIME_S_ELAPSED = "PSG.K_TIME_S_ELAPSED"  # interval count template
PSG.K_TIME_S_TOGO = "PSG.K_TIME_S_TOGO"  # interval count template
