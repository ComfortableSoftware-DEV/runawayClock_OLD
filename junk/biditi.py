...
mainLayout = [  # FMAXPSG_SCTN090B_COLUMN_DEF FMAXPSG_SCTN090E_LAYOUT_DEF <COL|LAYOUT>[NAME]

FMPSG_SCTN090B_COLUMN_DICT {ROWKEY} = ""
00	00 [  # FMAXPSG_SCTN090B_COLUMN_ROW_ADD FMPSG_SCTN090B_COLUMN_DICT =[NAME] =[ROWKEY] {} LEVEL
01		01 SG.Col(  # FMAXPSG_SCTN090B_COLUMN_PARM_ADD ELEMENTTYPE FMPSG_SCTN090B_COLUMN_DICT =[NAME] =[ROWKEY] LEVEL =""
02		02 CLMTIMER,  # FMAXPSG_SCTN090B_COLUMN_PARAM_ADDPARM FMPSG_SCTN090B_COLUMN_DICT [NAME] [ROWKEY] LEVEL +=<STR|VAL>
03		),
04	],

FMPSG_SCTN090B_COLUMN_DICT {ROWKEY} = ""
05	[  # FMAXPSG_SCTN090B_COLUMN_ROW_ADD NAME ROWKEY LEVEL
06		00 SG.Text(  # FMAXPSG_SCTN090B_COLUMN_TEXT_ADD NAME ROWKEY LEVEL
07			01 key="_upTime_",  # FMAXPSG_SCTN090B_COLUMN_KEY_ADD NAME ROWKEY LEVEL VALUE
08			01 **TEXTUPTIME,  # FMAXPSG_SCTN090B_COLUMN_PACKEDPARM_ADD NAME ROWKEY LEVEL VALUE
09		),
0A		00 SG.Text(
0B			01 key="_downTime_",  # FMAXPSG_SCTN090B_COLUMN_KEY_ADD NAME ROWKEY LEVEL VALUE
0C			01 **TEXTDOWNTIME,
0D		),
0E		00 SG.Col(  # FMAXPSG_SCTN090B_COLUMN_PARM_ADD ELEMENTTYPE NAME ROWKEY LEVEL

0F			01 [  # FMAXPSG_SCTN090B_COLUMN_ROW_ADD NAME ROWKEY LEVEL
10				02 [  # FMAXPSG_SCTN090B_COLUMN_ROW_ADD NAME ROWKEY LEVEL
11					03 SG.Btn(  # FMAXPSG_SCTN090B_COLUMN_BUTTON_ADD NAME ROWKEY LEVEL
12						04 key="Quit",  # FMAXPSG_SCTN090B_COLUMN_KEY_ADD NAME ROWKEY LEVEL VALUE
13						04 **BTNQUIT,  # FMAXPSG_SCTN090B_COLUMN_PACKEDPARM_ADD NAME ROWKEY LEVEL VALUE
14					),
15				],
00				[
00					SG.Btn(
00						key="zeroAll",  # FMAXPSG_SCTN090B_COLUMN_KEY_ADD NAME ROWKEY LEVEL VALUE
00						**BTNZEROALL,
00					),
00				],
00			],
...
interval auto dismiss after time
