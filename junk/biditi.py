...
mainLayout = [  # FMAX.SCTN090B_COLUMN_DEF FMAXPSG_SCTN090E_LAYOUT_DEF <COL|LAYOUT>[NAME]
...
08			01 **TEXTUPTIME,  # FMAX.SCTN090B_COLUMN_PACKEDPARM_ADD NAME ROWKEY LEVEL VALUE
09		),
0A		00 SG.Text(
0B			01 key="_downTime_",  # FMAX.SCTN090B_COLUMN_KEY_ADD NAME ROWKEY LEVEL VALUE
0C			01 **TEXTDOWNTIME,
0D		),
0E		00 SG.Col(  # FMAX.SCTN090B_COLUMN_PARM_ADD ELEMENTTYPE NAME ROWKEY LEVEL

0F			01 [  # FMAX.SCTN090B_COLUMN_ROW_ADD NAME ROWKEY LEVEL
10				02 [  # FMAX.SCTN090B_COLUMN_ROW_ADD NAME ROWKEY LEVEL
11					03 SG.Btn(  # FMAX.SCTN090B_COLUMN_BUTTON_ADD NAME ROWKEY LEVEL
12						04 key="Quit",  # FMAX.SCTN090B_COLUMN_KEY_ADD NAME ROWKEY LEVEL VALUE
13						04 **BTNQUIT,  # FMAX.SCTN090B_COLUMN_PACKEDPARM_ADD NAME ROWKEY LEVEL VALUE
14					),
15				],
00				[
00					SG.Btn(
00						key="zeroAll",  # FMAX.SCTN090B_COLUMN_KEY_ADD NAME ROWKEY LEVEL VALUE
00						**BTNZEROALL,
00					),
00				],
00			],
