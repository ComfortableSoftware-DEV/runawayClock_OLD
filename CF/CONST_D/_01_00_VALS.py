...
STR_SUBST_DICT = {
	...
	"%FOLDLN1E%": f"""{M.FOLD1ENDHERE}{NEWLINE}""",
	"%FOLDLN2E%": f"""{M.FOLD1STARTHERE}{NEWLINE}""",
	"%FOLDLN3E%": f"""{M.FOLD2ENDHERE}{NEWLINE}""",
	"%FOLDLN1S%": f"""{M.FOLD2STARTHERE}{NEWLINE}""",
	"%FOLDLN2S%": f"""{M.FOLD3ENDHERE}{NEWLINE}""",
	"%FOLDLN3S%": f"""{M.FOLD3STARTHERE}{NEWLINE}""",
	"%FTQ%": f"""f{TRIQT}""",
