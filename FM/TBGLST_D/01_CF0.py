...
TBGLST = [
	...
	(("FMAX.SCTN0003_LAMBDA_DEF", FM.FMAXFM_SCTN0101_AX_DEF, "define a lambda function <NAC><K_EVENT_NAME><lambda str>",), __ID__),
	(("FMAX.SCTN0003_TYPE_DEF", FM.FMAXFM_SCTN0101_AX_DEF, "define a fake type used in the translation dict <NAC><K_EVENT_NAME><TYPE>",), __ID__),
	(("FMAX.SCTN0201_STR_DEF", FM.FMAXFM_SCTN0101_AX_DEF, "define a STR in SCTN0201 <NAC><K_EVENT_NAME><str>",), __ID__),
	(("FMAX.SCTN0201_VAL_DEF", FM.FMAXFM_SCTN0101_AX_DEF, "define a VAL in SCTN0201 <NAC><K_EVENT_NAME><VAL>",), __ID__),
	(("FMAX.SCTN0202_OPTDICT_STR_ADD", FM.FMAXFM_SCTN0101_AX_DEF, "define a OPTNAME: 'str' in SCTN0202 <NAC><KEY><PARM><STRDEFAULT>",), __ID__),
	(("FMAX.SCTN0202_OPTDICT_VAL_ADD", FM.FMAXFM_SCTN0101_AX_DEF, "define a OPTNAME: VAL in SCTN0202 <NAC><KEY><PARM><VALDEFAULT>",), __ID__),
	(("FMAX.SCTN0202_OPT_ADD_HLPLN", FM.FMAXFM_SCTN0101_AX_DEF, "add a line to the help for a PARM, after the comment is automatically added<NAC><PARM><ADDONHELPLINE>",), __ID__),
	(("FMAX.SCTN0202_OPT_STR_ADD", FM.FMAXFM_SCTN0101_AX_DEF, "define a '-a[=]' in SCTN22 <NAC><PARM><KEY><VAL>",), __ID__),
	(("FMAX.SCTN0202_OPT_VAL_ADD", FM.FMAXFM_SCTN0101_AX_DEF, "define a '-a[=]' in SCTN22 <NAC><PARM><KEY><VAL>",), __ID__),
	...
	(("FMAXCF_____", FM.FMAX.NOP, "FMAXCF_ENDS",), __ID__),
