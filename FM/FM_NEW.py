...
# * #*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*
FILENAMES_DICT = {99}  # dict of filename: FD??
FMCF_SCTN0003_TYPE_CMNT_DICT = {99}  # SCTN009 types comments
FMCF_SCTN0003_TYPE_DICT = {99}  # SCTN003 types
FMCF_SCTN0201_DEF_CMNT_DICT = {99}  # SCTN201 defines comments dict
FMCF_SCTN0201_DEF_DICT = {99}  # SCTN201 defines dict
FMCF_SCTN0202_OPTIONS_CMNT_DICT = {99}  # SCTN202 OPTIONS comments dict
FMCF_SCTN0202_OPTIONS_DICT = {99}  # SCTN202 OPTIONS dict
FMCF_SCTN0202_OPTIONSDICT_CMNT_DICT = {99}  # SCTN202 OPTIONSDICT comments dict
FMCF_SCTN0202_OPTIONSDICT_DICT = {99}  # SCTN202 OPTIONSDICT
FMCF_SCTN0202_OPTIONSHELPDICT_DICT = {99}  # SCTN202 OPTIONS HELPDICT
FMCF_SCTN0203_DICT_CMNT_DICT = {99}  # SCTN203 dict comments dict
FMCF_SCTN0203_DICT_DICT = {99}  # SCTN203 dict dict
FMCF_SCTN0204_LIST_CMNT_DICT = {99}  # SCTN204 list comments dict
FMCF_SCTN0204_LIST_DICT = {99}  # SCTN204 list dict
FMFM_SCTN0101_AX_CMNT_DICT = {99}  # SCTN101 FMAX defined
FMFM_SCTN0101_AX_DICT = {99}  # SCTN101 FMAX defined
FMFM_SCTN0102_VAL_CMNT_DICT = {99}  # SCTN102 val
FMFM_SCTN0102_VAL_DICT = {99}  # SCTN102 val
FMFM_SCTN0103_DICT_CMNT_DICT = {99}  # SCTN103 dict defined
FMFM_SCTN0103_DICT_DICT = {99}  # SCTN103 dict defined
FMFM_SCTN0104_LIST_CMNT_DICT = {99}  # SCTN201 device defines
FMFM_SCTN0104_LIST_DICT = {99}  # SCTN201 device defines
FMFM_SCTN0105_LDICT_CMNT_DICT = {99}  # SCTN105 ldict defined
FMFM_SCTN0105_LDICT_DICT = {99}  # SCTN105 ldict defined
FMFM_SCTN0106_SCTN_CLASS_DICT = {99}  # holds anything under the h5:CLASS
FMFM_SCTN0106_SCTN_DICT = {99}  # everything h3 and bigger, and their immediate subs not h4-h6
FMFM_SCTN0106_SCTN_FUNC_DICT = {99}  # holds anything under the h5:FUNCTIONS
FMFM_SCTN0106_SCTN_VAR_DICT = {99}  # holds anything under the h5:VARIABLES
FMPSG_SCTN0900_DEF1_CMNT_DICT = {99}  # 
FMPSG_SCTN0900_DEF1_DICT = {99}  # 
FMPSG_SCTN0901_DEF2_CMNT_DICT = {99}  # define the dict to hold everything in SCTN0901
FMPSG_SCTN0901_DEF2_DICT = {99}  # define the dict to hold everything in SCTN0901
FMPSG_SCTN0902_DICT_CMNT_DICT = {99}  # define the dict to hold everything in SCTN0902
FMPSG_SCTN0902_DICT_DICT = {99}  # define the dict to hold everything in SCTN0902
FMPSG_SCTN0903_LIST_CMNT_DICT = {99}  # define the dict to hold everything in SCTN0903
FMPSG_SCTN0903_LIST_DICT = {99}  # define the dict to hold everything in SCTN0903
FMPSG_SCTN0904_PLATEQ_INNER_CMNT_DICT = {99}  # define the dict to hold everything in SCTN0904
FMPSG_SCTN0904_PLATEQ_INNER_DICT = {99}  # define the dict to hold everything in SCTN0904
FMPSG_SCTN0904_PLATEQ_OUTER_CMNT_DICT = {99}  # define the dict to hold everything in SCTN0904
FMPSG_SCTN0904_PLATEQ_OUTER_DICT = {99}  # define the dict to hold everything in SCTN0904
FMPSG_SCTN0905_TUPDICT_CMNT_DICT = {99}  # define the dict to hold everything in SCTN0905
FMPSG_SCTN0905_TUPDICT_DICT = {99}  # define the dict to hold everything in SCTN0905
FMPSG_SCTN0905_TUPDICT_TDD_DICT = {99}  # define the dict to hold everything in SCTN0905
FMPSG_SCTN0906_BTNS_CMNT_DICT = {99}  # 
FMPSG_SCTN0906_BTNS_DICT = {99}  # 
FMPSG_SCTN0907_SPIN_CMNT_DICT = {99}  # holds the spin element stuffs (TUPDICT)f
FMPSG_SCTN0907_SPIN_DICT = {99}  # holds the spin element stuffs (TUPDICT)
FMPSG_SCTN0907_SPIN_VALUES_LIST_DICT = {99}  # holds the spin element stuffs (TUPDICT)
FMPSG_SCTN0908_CHECKBOX_CMNT_DICT = {99}  # 
FMPSG_SCTN0908_CHECKBOX_DICT = {99}  # 
FMPSG_SCTN0909_TEXT_CMNT_DICT = {99}  # 
FMPSG_SCTN0909_TEXT_DICT = {99}  # 
FMPSG_SCTN090A_RADIO_CMNT_DICT = {99}  # 
FMPSG_SCTN090A_RADIO_DICT = {99}  # 
FMPSG_SCTN090B_COLUMN_CMNT_DICT = {99}  # 
FMPSG_SCTN090B_COLUMN_DICT = {99}  # 
FMPSG_SCTN090B_COLUMN_PARMS_DICT = {99}  # 
FMPSG_SCTN090C_APPDS_CMNT_DICT = {99}  # the main app dict for this app
FMPSG_SCTN090C_APPDS_DICT = {99}  # the main app dict for this app
FMPSG_SCTN090C_APPDSDICT_DICT = {99}  # the main app dict+dict for this app
FMPSG_SCTN090D_FORMMAIN_CMNT_DICT = {99}  # 
FMPSG_SCTN090D_FORMMAIN_DICT = {99}  # 
FMPSG_SCTN090E_LAYOUT_CMNT_DICT = {99}  # 
FMPSG_SCTN090E_LAYOUT_DICT = {99}  # 
FMPSG_SCTN090F_WINDOW_CMNT_DICT = {99}  # 
FMPSG_SCTN090F_WINDOW_DICT = {99}  # 
FMPSG_SCTN0910_DEF3_CMNT_DICT = {99}  # 
FMPSG_SCTN0910_DEF3_DICT = {99}  # 
FMPSG_SCTN0911_COMBO_CMNT_DICT = {99}  # 
FMPSG_SCTN0911_COMBO_DICT = {99}  # 
FMPSG_SCTN0912_FRAME_CMNT_DICT = {99}  # 
FMPSG_SCTN0912_FRAME_DICT = {99}  # 
FMPSG_SCTN0913_RCMENU_CMNT_DICT = {99}  # 
FMPSG_SCTN0913_RCMENU_DICT = {99}  # 
FMPSG_SCTN0914_FORMPOPUP_CMNT_DICT = {99}  # 
FMPSG_SCTN0914_FORMPOPUP_DICT = {99}  # 
FMPSG_SCTN0915_PUDLG_CMNT_DICT = {99}  # 
FMPSG_SCTN0915_PUDLG_DICT_DICT = {99}  # 
FMPSG_SCTN0915_PUDLG_LIST_DICT = {99}  # 
FMPSG_SCTN0915_PUDLG_TYPE_DICT = {99}  # 
FMPSG_SCTN0916_CLASS_SPIN_LIST_DICT = {99}  # holds the spin element stuffs (TUPDICT)
FMPSG_SCTN09FF_CLASS_BTNS_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_BTNS_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_BTNS_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_CHECKBOX_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_CHECKBOX_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_CHECKBOX_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_COLUMN_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_COLUMN_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_COLUMN_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_COLUMN_PARMS_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_COMBO_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_COMBO_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_COMBO_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_DEF_DICT = {99}  # str and val defines in a class
FMPSG_SCTN09FF_CLASS_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_DICT_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_DICT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_FRAME_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_FRAME_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_FRAME_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_FUNCTION_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_FUNCTION_DEF1_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_FUNCTION_DEF2_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_FUNCTION_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_INIT_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_INIT_DEF1_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_INIT_DEF2_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_INIT_DEF3_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_INIT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_INIT_DICTIN_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_INIT_DICTINSTR_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_LAYOUT_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_LAYOUT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_LIST_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_LIST_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_RADIO_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_RADIO_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_RADIO_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_RCMENU_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_RCMENU_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_RCMENU_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_SPIN_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_SPIN_CMNT_DICT = {99}  # holds the spin element stuffs (TUPDICT)f
FMPSG_SCTN09FF_CLASS_SPIN_DICT = {99}  # holds the spin element stuffs (TUPDICT)
FMPSG_SCTN09FF_CLASS_TEXT_ADDON_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_TEXT_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_TEXT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_WINDOW_CMNT_DICT = {99}  # 
FMPSG_SCTN09FF_CLASS_WINDOW_DICT = {99}  # 
...
#
		...
		FMFM_SCTN0106_SCTN_CLASS_DICT, {
		FMFM_SCTN0106_SCTN_DICT, {
		FMFM_SCTN0106_SCTN_FUNC_DICT, {
		FMFM_SCTN0106_SCTN_VAR_DICT, {
