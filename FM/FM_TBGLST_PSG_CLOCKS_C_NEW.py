...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_TIME_MS_AT_UNHIDE", "PSG.ZERO_CLOCK", "the time length will stay hidden under the mouse",), __ID__),
	...
	(("PSGVAL__CLOCKS_FUNC_03_HIDE", FM.FMAXPSG_SCTN09FF_CLASS_FUNCTION_DEF_FROM_FILE, "CLOCKS", "hide", "hide.py", "False", "convert any str in _DICTIN_ to int",), __ID__),
	...
	(("PSGVAL__CLOCKS_FUNC_03_UNHIDE", FM.FMAXPSG_SCTN09FF_CLASS_FUNCTION_DEF_FROM_FILE, "CLOCKS", "unhide", "unhide.py", "False", "convert any str in _DICTIN_ to int",), __ID__),
