...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_DPD01", FM.FMAXPSG_SCTN09FF_CLASS_DPD_VV_ADD, "CLOCKS", "_DPD_", "PSG.F___INIT__", "True", "define a DPD at /",), __ID__),
	...
	(("PSGVAL__CLOCKS_FUNC_00_INIT03_KEY01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_FOREIGN_KEY, "CLOCKS", "PSG.PSG.K_CURRENT_INTERVAL_COUNT", "True", "add foreign key for CURRENT_INTERVAL_COUNT",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_CURRENT_INTERVAL_COUNT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_CURRENT_INTERVAL_COUNT_", "KEY", "PSG.PSG.K_CURRENT_INTERVAL_COUNT", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_NAME_NEXT_EVENT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_NAME_NEXT_EVENT_", "KEY", "PSG.k_NAME_NEXT_EVENT", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_AT_ZERO01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_AT_ZEROELAPSE_", "KEY", "PSG.k_TIME_S_AT_ZEROELAPSE", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_AT_NEXT_ALERT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_AT_NEXT_ALERT_", "KEY", "PSG.k_TIME_S_AT_NEXT_ALERT", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_CLOCK01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_CLOCK_", "KEY", "PSG.k_TIME_S_CLOCK", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_ELAPSED01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_ELAPSED_", "KEY", "PSG.k_TIME_S_ELAPSED", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_TOGO01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_TOGO_", "KEY", "PSG.k_TIME_S_TOGO", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "ALPHA_CHANNEL", "PSG.SZ_ALPHA_HIGH", "set the high alpha as the default",), __ID__),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "BACKGROUND_COLOR", "PSG.COLOR_BACKGROUND", "eliminate all not useful on the floating clocks",), __ID__),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "BORDER_DEPTH", "PSG.SZ_BORDER_DEPTH", "border depth to zero",), __ID__),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "ELEMENT_PADDING", "PSG.SZ_PAD_ALL", "all padding for elements ((1, 1), (1, 1)) by default",), __ID__),
	...
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "MARGINS", "PSG.SZ_MARGINS_ALL", "",), __ID__),
