...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_FUNC_03_ENSTRING", FM.FMAXPSG_SCTN09FF_CLASS_FUNCTION_DEF_FROM_FILE, "CLOCKS", "enstring", "enstring.py", "True", "read the frame and set self._RESULT_",), __ID__),
