...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_LAYOUT_", "self._LAYOUTB_", "set the default layout option",), __ID__),
	...
	(("PSGVAL__CLOCKS_LAYOUTA", FM.FMAX_NOP, "layout for APPMODE_CLOCKS",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTA00", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_DEF, "CLOCKS", "_LAYOUTA_", "layout for APPMODE_CLOCKS",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTA01", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_ROW_ADD, "CLOCKS", "_LAYOUTA_", "LAYOUTA_ROW_00", "L03", "add a row to the layout",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTA02", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_COLUMN_ADD, "CLOCKS", "_LAYOUTA_", "LAYOUTA_ROW_00", "L04", "LAYOUTA_E01", "add a column",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTA03", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUTA_", "LAYOUTA_ROW_00", "L05", "LAYOUTA_E01", "layout", "self._COLUMN01A_", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTA04", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUTA_", "LAYOUTA_ROW_00", "L05", "LAYOUTA_E01", "pad", "PSG.SZ_PAD_ALL", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTA05", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_COLUMN_ADD, "CLOCKS", "_LAYOUTA_", "LAYOUTA_ROW_00", "L04", "LAYOUTA_E02", "add a column",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTA06", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUTA_", "LAYOUTA_ROW_00", "L05", "LAYOUTA_E02", "layout", "self._COLUMN02_", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTA07", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUTA_", "LAYOUTA_ROW_00", "L05", "LAYOUTA_E02", "pad", "PSG.SZ_PAD_ALL", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB", FM.FMAX_NOP, "layout for APPMODE_CLOCKS",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB00", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_DEF, "CLOCKS", "_LAYOUTB_", "layout for APPMODE_CLOCKS",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB01", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_ROW_ADD, "CLOCKS", "_LAYOUTB_", "LAYOUTB_ROW_00", "L03", "add a row to the layout",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB02", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_COLUMN_ADD, "CLOCKS", "_LAYOUTB_", "LAYOUTB_ROW_00", "L04", "LAYOUTB_E01", "add a column",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB03", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUTB_", "LAYOUTB_ROW_00", "L05", "LAYOUTB_E01", "layout", "self._COLUMN01B_", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB04", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUTB_", "LAYOUTB_ROW_00", "L05", "LAYOUTB_E01", "pad", "PSG.SZ_PAD_ALL", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB05", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_COLUMN_ADD, "CLOCKS", "_LAYOUTB_", "LAYOUTB_ROW_00", "L04", "LAYOUTB_E02", "add a column",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB06", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUTB_", "LAYOUTB_ROW_00", "L05", "LAYOUTB_E02", "layout", "self._COLUMN02_", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUTB07", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUTB_", "LAYOUTB_ROW_00", "L05", "LAYOUTB_E02", "pad", "PSG.SZ_PAD_ALL", "comment",), __ID__),
