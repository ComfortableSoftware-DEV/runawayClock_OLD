...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_COLUMN01A0F", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_TEXT_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_03", "L04", "COLUMN01A_E06", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A10", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_03", "L05", "COLUMN01A_E06", "**self._TEXT_NAME_NEXT_EVENT_", "add the main clock",), __ID__),
	...
	(("PSGVAL__CLOCKS_COLUMN01A12", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_CHECKBOX_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_04", "L04", "COLUMN01A_E07", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A13", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_04", "L05", "COLUMN01A_E07", "**PSG.CHECKBOX_RUNAWAY01", "add elapsed time",), __ID__),
	...
	(("PSGVAL__CLOCKS_COLUMN01A16", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_ROW_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L03", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A17", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_CHECKBOX_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L04", "COLUMN01A_E08", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A18", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L05", "COLUMN01A_E08", "**PSG.CHECKBOX_RUNAWAY01", "add elapsed time",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A19", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_CHECKBOX_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L04", "COLUMN01A_E09", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A1A", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L05", "COLUMN01A_E09", "**PSG.CHECKBOX_ALPHA_DIM01", "add elapsed time",), __ID__),
	...
	(("PSGVAL__CLOCKS_COLUMN01B15", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01B_", "COLUMN01B_ROW_04", "L05", "COLUMN01B_E08", "**PSG.CHECKBOX_RUNAWAY01", "add elapsed time",), __ID__),
	...
	(("PSGVAL__CLOCKS_COLUMN01B17", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01B_", "COLUMN01B_ROW_04", "L05", "COLUMN01B_E09", "**PSG.CHECKBOX_ALPHA_DIM01", "add elapsed time",), __ID__),
