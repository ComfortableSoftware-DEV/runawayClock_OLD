...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_TEXT_CURRENT_INTERVAL_COUNT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_CURRENT_INTERVAL_COUNT_", "KEY", "PSG.K_CURRENT_INTERVAL_COUNT", "interval count template",), __ID__),
