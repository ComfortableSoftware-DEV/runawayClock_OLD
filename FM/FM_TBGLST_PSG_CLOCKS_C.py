...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_COLUMN01B00", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_DEF, "CLOCKS", "_COLUMN01B_", "the column that puts the two smaller clocks below the main one",), __ID__),
