...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_COLUMN01A00", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_DEF, "CLOCKS", "_COLUMN01A_", "the column that puts the two smaller clocks below the main one",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A01", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_ROW_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_00", "L03", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A02", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_TEXT_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_00", "L04", "COLUMN01A_E01", "add a new TEXT element to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A03", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_00", "L05", "COLUMN01A_E01", "**self._TEXT_TIME_S_CLOCK_", "add the main clock",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A04", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_ROW_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_01", "L03", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A05", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_TEXT_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_01", "L04", "COLUMN01A_E02", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A06", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_01", "L05", "COLUMN01A_E02", "**self._TEXT_TIME_S_AT_ZEROELAPSE_", "add time to go",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A07", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_TEXT_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_01", "L04", "COLUMN01A_E03", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A08", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_01", "L05", "COLUMN01A_E03", "**self._TEXT_TIME_S_ELAPSED_", "add elapsed time",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A09", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_ROW_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_02", "L03", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A0A", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_TEXT_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_02", "L04", "COLUMN01A_E04", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A0B", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_02", "L05", "COLUMN01A_E04", "**self._TEXT_TIME_S_TOGO_", "add elapsed time",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A0C", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_TEXT_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_02", "L04", "COLUMN01A_E05", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A0D", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_02", "L05", "COLUMN01A_E05", "**self._TEXT_TIME_S_AT_NEXT_ALERT_", "add time to go",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A0E", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_ROW_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_03", "L03", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A0F", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_TEXT_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_03", "L04", "COLUMN01A_E06", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A10", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_03", "L05", "COLUMN01A_E06", "**self._TEXT_NAME_NEXT_EVENT_", "add the main clock",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A11", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_ROW_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_04", "L03", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A12", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_CHECKBOX_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_04", "L04", "COLUMN01A_E07", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A13", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_04", "L05", "COLUMN01A_E07", "**PSG.CHECKBOX_RUNAWAY01", "add elapsed time",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A14", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_CHECKBOX_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_04", "L04", "COLUMN01A_E08", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A15", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_04", "L05", "COLUMN01A_E08", "**PSG.CHECKBOX_ALPHA_DIM01", "add elapsed time",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A16", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_ROW_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L03", "add a new row to clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A17", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_CHECKBOX_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L04", "COLUMN01A_E09", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A18", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L05", "COLUMN01A_E09", "**PSG.CHECKBOX_HIDE01", "add elapsed time",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A19", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_CHECKBOX_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L04", "COLUMN01A_E0A", "add a new text element to row01 clocks column",), __ID__),
	(("PSGVAL__CLOCKS_COLUMN01A1A", FM.FMAX_NOP, FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01A_", "COLUMN01A_ROW_05", "L05", "COLUMN01A_E0A", "**PSG.CHECKBOX_HOVER_DATE01", "add elapsed time",), __ID__),
