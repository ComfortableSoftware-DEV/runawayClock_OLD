...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_TEXT_CURRENT_INTERVAL_COUNT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_CURRENT_INTERVAL_COUNT_", "PSG.KEY", "K_CURRENT_INTERVAL_COUNT", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_NAME_NEXT_EVENT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_NAME_NEXT_EVENT_", "PSG.KEY", "K_NAME_NEXT_EVENT", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_AT_ZERO01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_AT_ZEROELAPSE_", "PSG.KEY", "K_TIME_S_AT_ZEROELAPSE", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_AT_NEXT_ALERT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_AT_NEXT_ALERT_", "PSG.KEY", "K_TIME_S_AT_NEXT_ALERT", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_CLOCK01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_CLOCK_", "PSG.KEY", "K_TIME_S_CLOCK", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_ELAPSED01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_ELAPSED_", "PSG.KEY", "K_TIME_S_ELAPSED", "interval count template",), __ID__),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_TOGO01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_TOGO_", "PSG.KEY", "K_TIME_S_TOGO", "interval count template",), __ID__),
