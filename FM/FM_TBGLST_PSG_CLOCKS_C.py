...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_LAYOUT01", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_ROW_ADD, "CLOCKS", "_LAYOUT_", "LAYOUTA_ROW_00", "L03", "add a row to the layout",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUT02", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_COLUMN_ADD, "CLOCKS", "_LAYOUT_", "LAYOUTA_ROW_00", "L04", "LAYOUTA_E01", "add a column",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUT03", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUT_", "LAYOUTA_ROW_00", "L05", "LAYOUTA_E01", "layout", "self._COLUMN01_", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUT04", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUT_", "LAYOUTA_ROW_00", "L05", "LAYOUTA_E01", "pad", "PSG.SZ_PAD_ALL", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUT05", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_COLUMN_ADD, "CLOCKS", "_LAYOUT_", "LAYOUTA_ROW_00", "L04", "LAYOUTA_E02", "add a column",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUT06", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUT_", "LAYOUTA_ROW_00", "L05", "LAYOUTA_E02", "layout", "self._COLUMN02_", "comment",), __ID__),
	(("PSGVAL__CLOCKS_LAYOUT07", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUT_", "LAYOUTA_ROW_00", "L05", "LAYOUTA_E02", "pad", "PSG.SZ_PAD_ALL", "comment",), __ID__),
