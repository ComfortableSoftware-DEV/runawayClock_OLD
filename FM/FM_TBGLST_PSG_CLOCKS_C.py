...
TBGLST = [
	...
	(("PSGVAL__CLOCKS_COLUMN0113", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01_", "COLUMN01_ROW_04", "L05", "COLUMN01_E06", "**CHECKBOX_RUNAWAY01", "add elapsed time",), __ID__,),
	...
	(("PSGVAL__CLOCKS_COLUMN0115", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN01_", "COLUMN01_ROW_04", "L05", "COLUMN01_E07", "**CHECKBOX_ALPHA_DIM01", "add elapsed time",), __ID__,),
	...
	(("PSGVAL__CLOCKS_COLUMN0203", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN02_", "COLUMN02_ROW_01", "L05", "COLUMN02_E01", "**BTN_QUIT20", "add the xpand button to clocks",), __ID__,),
	...
	(("PSGVAL__CLOCKS_COLUMN0206", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN02_", "COLUMN02_ROW_02", "L05", "COLUMN02_E02", "**BTN_ZERO20", "add the zero button to clocks",), __ID__,),
	...
	(("PSGVAL__CLOCKS_COLUMN0209", FM.FMAXPSG_SCTN09FF_CLASS_COLUMN_PARM_ADD, "CLOCKS", "_COLUMN02_", "COLUMN02_ROW_03", "L05", "COLUMN02_E03", "**BTN_XPAND20", "add the zero button to clocks",), __ID__,),
	...
	(("PSGVAL__CLOCKS_DICT_VALUES01", FM.FMAX_NOP, "FMAXPSG_SCTN09FF_CLASS_DICT_DEF", "CLOCKS", "_VALUES_", "K_CHECKBOX_ALPHA_DIM", "True", "checkbox alpha dim",), __ID__,),
	(("PSGVAL__CLOCKS_DICT_VALUES01", FM.FMAX_NOP, "FMAXPSG_SCTN09FF_CLASS_DICT_DEF", "CLOCKS", "_VALUES_", "K_CHECKBOX_RUNAWAY", "False", "checkbox alpha dim",), __ID__,),
	...
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_ALPHA_CHANNEL_", "SZ_ALPHA_HIGH", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_ALPHA_HIGH_", "SZ_ALPHA_HIGH", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_ALPHA_LOW_", "SZ_ALPHA_LOW", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_BBOX_", "EMPTY_BBOX", "",), __ID__,),
	...
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_CLOSE_BBOX_", "EMPTY_BBOX", "",), __ID__,),
	...
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_CURRENT_LOCATION_", "EMPTY_XY", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_CURRENT_MOUSE_LOCATION_", "EMPTY_XY", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_CURRENT_MOUSE_STATUS_", "MOUSE_STATUS_NONE", "",), __ID__,),
	...
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_MPX_", "EMPTY_XY", "comment",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_SCREEN_DIMS_", "EMPTY_XY", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_SIZE_", "EMPTY_XY", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_TIME_MS_AT_CHECK_MOUSE_", "ZERO_CLOCK", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_TIME_MS_AT_FLIP_", "ZERO_CLOCK", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_TIME_MS_AT_MOVE_", "ZERO_CLOCK", "",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_VAL, "CLOCKS", "_TIME_MS_AT_UPDATE_", "ZERO_CLOCK", "",), __ID__,),
	...
	(("PSGVAL__CLOCKS_FUNC_00_INIT02_DICTIN01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_DICTIN_VV, "CLOCKS", "K_TIME_S_AT_NEXT_ALERT", "ZERO_CLOCK", "True", "time at next event",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT02_DICTIN01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_DICTIN_VV, "CLOCKS", "K_TIME_S_AT_ZEROELAPSE", "ZERO_CLOCK", "True", "time at last zero of elapsed timer",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT02_DICTIN01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_DICTIN_VV, "CLOCKS", "K_TIME_S_CLOCK", "ZERO_CLOCK", "True", "time clock or wall clock",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT02_DICTIN01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_DICTIN_VV, "CLOCKS", "K_TIME_S_ELAPSED", "ZERO_CLOCK", "True", "time elapsed",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT02_DICTIN01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_DICTIN_VV, "CLOCKS", "K_TIME_S_TOGO", "ZERO_CLOCK", "True", "countdown to next event",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT03_KEY01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_FOREIGN_KEY, "CLOCKS", "K_CHECKBOX_ALPHA_DIM", "False", "add foreign key for alpha dimming",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT03_KEY01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_FOREIGN_KEY, "CLOCKS", "K_CHECKBOX_RUNAWAY", "False", "add foreign key for runningaway",), __ID__,),
	(("PSGVAL__CLOCKS_FUNC_00_INIT03_KEY01", FM.FMAXPSG_SCTN09FF_CLASS_INIT_ADD2_FOREIGN_KEY, "CLOCKS", "K_CURRENT_INTERVAL_COUNT", "True", "add foreign key for CURRENT_INTERVAL_COUNT",), __ID__,),
	...
	(("PSGVAL__CLOCKS_LAYOUT04", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUT_", "LAYOUT_ROW_00", "L05", "LAYOUT_E01", "pad", "SZ_PAD_ALL", "comment",), __ID__,),
	...
	(("PSGVAL__CLOCKS_LAYOUT07", FM.FMAXPSG_SCTN09FF_CLASS_LAYOUT_PARM_VAL_ADD, "CLOCKS", "_LAYOUT_", "LAYOUT_ROW_00", "L05", "LAYOUT_E02", "pad", "SZ_PAD_ALL", "comment",), __ID__,),
	...
	(("PSGVAL__CLOCKS_LIST_FLIPPABLE_KEYS01", FM.FMAXPSG_SCTN09FF_CLASS_LIST_VAL_ADD, "CLOCKS", "_LIST_FLIPPABLE_KEYS_", "K_TEXT_CURRENT_INTERVAL_COUNT", "list of the items that can be str|list[str, str, ..]",), __ID__,),
	(("PSGVAL__CLOCKS_LIST_FLIPPABLE_KEYS01", FM.FMAXPSG_SCTN09FF_CLASS_LIST_VAL_ADD, "CLOCKS", "_LIST_FLIPPABLE_KEYS_", "K_TEXT_NAME_NEXT_EVENT", "list of the items that can be str|list[str, str, ..]",), __ID__,),
	(("PSGVAL__CLOCKS_RCMENU01", FM.FMAXPSG_SCTN09FF_CLASS_RCMENU_DEF, "CLOCKS", "_RCMENU01_", "right click to do the things",), __ID__,),
	(("PSGVAL__CLOCKS_RCMENU0101", FM.FMAXPSG_SCTN09FF_CLASS_RCMENU_VAL_ADD, "CLOCKS", "_RCMENU01_", "K_BTN_QUIT_ALL", "quit by right click",), __ID__,),
	(("PSGVAL__CLOCKS_RCMENU0101", FM.FMAXPSG_SCTN09FF_CLASS_RCMENU_VAL_ADD, "CLOCKS", "_RCMENU01_", "K_BTN_XPAND", "quit by right click",), __ID__,),
	(("PSGVAL__CLOCKS_RCMENU0101", FM.FMAXPSG_SCTN09FF_CLASS_RCMENU_VAL_ADD, "CLOCKS", "_RCMENU01_", "K_BTN_ZERO", "quit by right click",), __ID__,),
	(("PSGVAL__CLOCKS_RCMENU0101", FM.FMAXPSG_SCTN09FF_CLASS_RCMENU_VAL_ADD, "CLOCKS", "_RCMENU01_", "K_CHECKBOX_ALPHA_DIM", "toggle K_CHECKBOX_ALPHA_DIM",), __ID__,),
	(("PSGVAL__CLOCKS_RCMENU0101", FM.FMAXPSG_SCTN09FF_CLASS_RCMENU_VAL_ADD, "CLOCKS", "_RCMENU01_", "K_CHECKBOX_RUNAWAY", "toggle K_CHECKBOX_RUNAWAY",), __ID__,),
	...
	(("PSGVAL__CLOCKS_TEXT_CURRENT_INTERVAL_COUNT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_PARM_ADD, "CLOCKS", "_TEXT_CURRENT_INTERVAL_COUNT_", "**TEXT_CURRENT_INTERVAL_COUNT", "interval count template",), __ID__,),
	(("PSGVAL__CLOCKS_TEXT_CURRENT_INTERVAL_COUNT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_CURRENT_INTERVAL_COUNT_", "KEY", "K_CURRENT_INTERVAL_COUNT", "interval count template",), __ID__,),
	...
	(("PSGVAL__CLOCKS_TEXT_NAME_NEXT_EVENT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_PARM_ADD, "CLOCKS", "_TEXT_NAME_NEXT_EVENT_", "**TEXT_NAME_NEXT_EVENT", "interval count template",), __ID__,),
	(("PSGVAL__CLOCKS_TEXT_NAME_NEXT_EVENT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_NAME_NEXT_EVENT_", "KEY", "K_NAME_NEXT_EVENT", "interval count template",), __ID__,),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_AT_ZERO01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_PARM_ADD, "CLOCKS", "_TEXT_TIME_S_AT_ZEROELAPSE_", "**TEXT_TIME_S_AT_ZEROELAPSE", "interval count template",), __ID__,),
	(("PSGVAL__CLOCKS_TEXT_TIME_AT_ZERO01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_AT_ZEROELAPSE_", "KEY", "K_TIME_S_AT_ZEROELAPSE", "interval count template",), __ID__,),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_AT_NEXT_ALERT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_PARM_ADD, "CLOCKS", "_TEXT_TIME_S_AT_NEXT_ALERT_", "**TEXT_TIME_S_AT_NEXT_ALERT", "interval count template",), __ID__,),
	(("PSGVAL__CLOCKS_TEXT_TIME_S_AT_NEXT_ALERT01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_AT_NEXT_ALERT_", "KEY", "K_TIME_S_AT_NEXT_ALERT", "interval count template",), __ID__,),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_CLOCK01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_PARM_ADD, "CLOCKS", "_TEXT_TIME_S_CLOCK_", "**TEXT_TIME_S_CLOCK", "interval count template",), __ID__,),
	(("PSGVAL__CLOCKS_TEXT_TIME_S_CLOCK01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_CLOCK_", "KEY", "K_TIME_S_CLOCK", "interval count template",), __ID__,),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_ELAPSED01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_PARM_ADD, "CLOCKS", "_TEXT_TIME_S_ELAPSED_", "**TEXT_TIME_S_ELAPSED", "interval count template",), __ID__,),
	(("PSGVAL__CLOCKS_TEXT_TIME_S_ELAPSED01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_ELAPSED_", "KEY", "K_TIME_S_ELAPSED", "interval count template",), __ID__,),
	...
	(("PSGVAL__CLOCKS_TEXT_TIME_S_TOGO01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_PARM_ADD, "CLOCKS", "_TEXT_TIME_S_TOGO_", "**TEXT_TIME_S_TOGO", "interval count template",), __ID__,),
	(("PSGVAL__CLOCKS_TEXT_TIME_S_TOGO01", FM.FMAXPSG_SCTN09FF_CLASS_TEXT_VAL_ADD, "CLOCKS", "_TEXT_TIME_S_TOGO_", "KEY", "K_TIME_S_TOGO", "interval count template",), __ID__,),
	...
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "ALPHA_CHANNEL", "SZ_ALPHA_HIGH", "set the high alpha as the default",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "BACKGROUND_COLOR", "COLOR_BACKGROUND", "eliminate all not useful on the floating clocks",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "BORDER_DEPTH", "SZ_BORDER_DEPTH", "border depth to zero",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "ELEMENT_PADDING", "SZ_PAD_ALL", "all padding for elements ((1, 1), (1, 1)) by default",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "FORCE_TOPLEVEL", "None", "",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "GRAB_ANYWHERE", "True", "eliminate all not useful on the floating clocks",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "KEEP_ON_TOP", "True", "eliminate all not useful on the floating clocks",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "LAYOUT", "self._LAYOUT_", "add the layout for CLOCKS_WINDOW",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "MARGINS", "SZ_MARGINS_ALL", "",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "NO_TITLEBAR", "True", "no titlebar on APPMODE_CLOCKS window",), __ID__,),
	(("PSGVAL__CLOCKS_WINDOW01", FM.FMAXPSG_SCTN09FF_CLASS_WINDOW_VAL_ADD, "CLOCKS", "_WINDOW_", "TITLE", "TITLE_CLOCKS", "",), __ID__,),
]
